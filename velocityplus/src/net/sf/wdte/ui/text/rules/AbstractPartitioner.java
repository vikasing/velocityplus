 ...
 * 
 * $Id: AbstractPartitioner.java,v 1.3 2004/02/29 17:54:37 l950637 Exp $
 */
...
//		return false;
	...
	/**
	 * Returns a content type encoded in the given token. If the token's data
	 * is not <code>null</code> and a string it is assumed that it is the
