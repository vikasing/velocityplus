...
public class VelocityColorProvider implements IColorConstants
{
    ...
    private static final RGB RGB_JS_COMMENT_COLOR = new RGB(63,127,95);
    private static final RGB RGB_JS_STRING_COLOR  = new RGB(42,0,255);
    private static final RGB RGB_JS_KEYWORD_COLOR = new RGB(127,0,85);
    private static final RGB RGB_JS_DEFAULT_COLOR = new RGB(0,0,0);
    ...
    public static void initializeDefaults(IPreferenceStore aStore)
    {
        ...
        PreferenceConverter.setDefault(aStore, IPreferencesConstants.P_COMMENT_COLOR, RGB_JS_COMMENT_COLOR);
        PreferenceConverter.setDefault(aStore, IPreferencesConstants.P_STRING_COLOR, RGB_JS_STRING_COLOR);
        PreferenceConverter.setDefault(aStore, IPreferencesConstants.P_DEFAULT_COLOR, RGB_JS_DEFAULT_COLOR);
        PreferenceConverter.setDefault(aStore, IPreferencesConstants.P_KEYWORD_COLOR, RGB_JS_KEYWORD_COLOR);
